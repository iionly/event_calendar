...
if (!(($group instanceof ElggGroup) && ($event instanceof EventCalendar) && $group->canEdit())) {
	return elgg_error_response(elgg_echo('event_calendar:add_to_group_members:error'), "event_calendar/manage_users/$event_guid");
}
...
return elgg_ok_response('', elgg_echo('event_calendar:add_to_group_members:success'), "event_calendar/manage_users/$event_guid");
