...
echo elgg_echo('event_calendar:export:type') . ' ';
...
echo elgg_echo('event_calendar:filter') . ' ';
echo elgg_view('input/select', array(
	'name' => 'filter',
	'value' => $vars['filter'],
	'options_values' => array(
