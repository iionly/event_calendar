...
echo elgg_echo('event_calendar:import:type') . ' ';
...
echo elgg_echo('event_calendar:file:upload') . '<br>';
echo elgg_view('input/file', array('name' => 'ical_file'));

echo '<br><br>';

echo elgg_echo('event_calendar:timezone') . '<br>';
...
echo elgg_echo('event_calendar:import:access') . ' ';
