...
$event_calendar_collision_length = (int) elgg_get_plugin_setting('collision_length', 'event_calendar');
$body .= elgg_view_field([
	'#type' => 'number',
...
$event_calendar_set_organizer = elgg_get_plugin_setting('set_organizer', 'event_calendar');
$body .= elgg_view_field([
	'#type' => 'radio',
